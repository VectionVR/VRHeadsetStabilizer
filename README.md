...
- Java based software available [here](https://github.com/VectionVR/VRHeadsetStabilizer/tree/master/stabilizer) that will grab platform orientation and send it to our modified Oculus Rift library with a **sub millisecond** latency. 
